// https://github.com/pandeynmn/nmns-extensions/blob/main/src/MangaReaderTo/PoorMansCanvas.ts
...
class ImageData {
	constructor(public width: number, public height: number, public data: Buffer) {}
